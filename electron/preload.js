...
contextBridge.exposeInMainWorld('electron', {
     ...
     * @returns {string} 
     */
    loadPromptMetadata: (path) => ipcRenderer.invoke(ipcping.LOAD_PROMPT_METADATA, path),
    ...
    executePlugin: (pluginPath) => ipcRenderer.invoke(ipcping.DELETE_HISTORY, pluginPath),
});
