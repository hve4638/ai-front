...
import { PromptVar, PromptVarSelectOption, PromptVarType } from 'types/prompt-variables';
import {
    Additions,
} from './additions';
...
const VAR_DROPDOWN_ITEMS = [
    ...
    dropdownItem('배열', PromptVarType.Array),
]
...
function EditPromptVarModal({
    ...
    useLayoutEffect(()=>{
        ...
        if (promptVar.type != PromptVarType.Struct) {
