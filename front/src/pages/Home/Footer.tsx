...
export default function Footer({ onOpenDebug }:FooterProps) {
    ...
    useEffect(()=>{
        LocalAPI.isNewVersionAvailable()
        .then(data=>{
            if (data) {
        ...
        <div className='expand-section row main-spacebetween undraggable'>
            <div className='noflex'>
                <img
                    ...
                    src={GithubIcon}
                    alt='github-icon'
                    onClick={()=> LocalAPI.openBrowser(GITHUB_LINK)}
                />
                <div className='noflex'>
                    <div className='footer-version-container column'>
                        {
                            ...
                            <div
                                ...
                                onClick={()=>LocalAPI.openBrowser(DOWNLOAD_LINK)}
                            >
            ...
            }
            {
                ...
                <>
                    ...
                    <GoogleFontIconButton
                        ...
                        value='folder_open'
                        //@TODO : 임시 구현
                        onClick={()=>LocalAPI.openPromptDirectory('guest')}
                    />
                </>
            }
        </div>
