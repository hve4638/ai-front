...
type IPCInvokeIntrerface = {
    ...
    /* 프로필 RT 노드 */
    [IPCInvokerName.GetProfileRTMetadata]: (profileId:string, rtId:string, node:string) => ElectronResult<number>;
    [IPCInvokerName.SetProfileRTMetadata]: (profileId:string, rtId:string, nodeId:string) => ElectronNoResult;
    [IPCInvokerName.AddProfileRTNode]: (profileId:string, rtId:string, node:string) => ElectronResult<number>;
    [IPCInvokerName.RemoveProfileRTNode]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.UpdateProfileRTNodeData]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.DisconnectProfileRTNode]: (profileId:string, rtId:string) => ElectronResult<RTInput>;

    /* 프로필 RT 프롬프트 */
    [IPCInvokerName.GetProfileRTPromptMetadata]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.SetProfileRTPromptMetadata]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.GetProfileRTPromptForms]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.SetProfileRTPromptForm]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.RemoveProfileRTPromptForm]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.GetProfileRTPromptContents]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
    [IPCInvokerName.SetProfileRTPromptContents]: (profileId:string, rtId:string) => ElectronResult<RTInput>;
